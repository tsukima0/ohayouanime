...
import type { NewEpisodeItem } from "@/lib/mock-data";
...
export default function NewEpisodeCard({ item, index }: NewEpisodeCardProps) {
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[11px] text-muted-foreground">{item.releasedAgo}</span>
          </div>
          <p className="text-xs font-semibold text-primary">{item.animeName}</p>
