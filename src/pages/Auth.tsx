        ...
        {(mode === "login" || mode === "signup") && (
          <>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-secondary border border-border text-foreground font-semibold text-sm hover:bg-accent disabled:opacity-50 transition-all flex items-center justify-center gap-2 mt-2"
            >
